...
function ProfilePopup({componentStyle, displayName, email, logOut, setIsProfileOpen, photoURL}) {
  ...
  return (
    <div className={` ${componentStyle} w-64 bg-white rounded-lg p-3  shadow-n2 border border-solid border-neutral-100`}>
      <div className='flex gap-3 items-center border-0 border-b border-gray-200 border-solid pb-4 mb-2'>
