...
function ZoomUi({ titleTip, subTitleTip, needButton, buttonText }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-hidden rounded-xl p-12">
      ...
      <h2 className="relative z-10 mb-3 text-xl/none font-bold text-neutral-900">
        {titleTip}
      </h2>
      <p className="relative z-10 mb-6 text-center text-base/snug text-neutral-500">
        {subTitleTip}
      </p>
      ...
      {needButton ? (
        <Link to="/create">
          <button className="relative z-10 flex overflow-hidden rounded-lg border border-solid border-neutral-300 bg-white active:bg-neutral-50">
            <span className="border-0 border-r border-solid border-neutral-200 p-2 text-center text-base/none font-medium text-neutral-900">
              <FiPlus />
            </span>
            <p className="p-2 px-4 text-center text-base/none text-neutral-500">
              {buttonText}
            </p>
          </button>
        </Link>
